...
public:
    inline Q3PtrListStdIterator(Q3LNode* n)
        : Q3GListStdIterator(n)
    {
    }
    ...
    inline Q3PtrListStdIterator<type> operator++(int)
    {
        Q3LNode* n = node;
        node = next();
        return Q3PtrListStdIterator<type>(n);
    }
...
public:
    Q3PtrList() { }
    Q3PtrList(const Q3PtrList<type>& l)
        : Q3GList(l)
    {
    }
    ~Q3PtrList() { clear(); }
...
template <>
inline void Q3PtrList<void>::deleteItem(Q3PtrCollection::Item)
{
}
#endif

template <class type>
inline void Q3PtrList<type>::deleteItem(Q3PtrCollection::Item d)
{
    if (del_item)
        delete (type*)d;
}
...
public:
    Q3PtrListIterator(const Q3PtrList<type>& l)
        : Q3GListIterator((Q3GList&)l)
    {
    }
    ~Q3PtrListIterator() { }
