...
public:
    Q3GDItList()
        : Q3PtrList<Q3GDictIterator>()
    {
    }
    Q3GDItList(const Q3GDItList& list)
        : Q3PtrList<Q3GDictIterator>(list)
    {
    }
    ~Q3GDItList() { clear(); }
    ...
    while (i < size()) {
        ...
        while (n) { // write all buckets
            ...
            case AsciiKey:
                ...
                break;
            case IntKey:
                s << (quint32)((Q3IntBucket*)n)->getKey();
                break;
            case PtrKey:
                s << (quint32)0; // ### cannot serialize a pointer
                break;
            }
