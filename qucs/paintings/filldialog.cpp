...
//  gp2->addMultiCellWidget(CheckFilled, 0,0,0,1);
  ...
  auto tt = FillColorButt->palette();
  tt.setColor(FillColorButt->backgroundRole(), QColor(0,0,0));
  FillColorButt->setPalette(tt);
...
{
        QColor c = QColorDialog::getColor(FillColorButt->palette().color(FillColorButt->backgroundRole()),this);
//  QColor c = QColorDialog::getColor(FillColorButt->paletteBackgroundColor(), this);
//  FillColorButt->setPaletteBackgroundColor(c);
  if(c.isValid())
  {
      auto tt = FillColorButt->palette();
      tt.setColor(FillColorButt->backgroundRole(), c);
      FillColorButt->setPalette(tt);
  }
}
